...
/**
 * Created by Xueyong on 2018/5/24.
 */
...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse createOrder(Integer userId,Integer shippingId){
        ...
        //生成成功，我们要减少我们产品的库存
        this.reduceProductStork(orderItemList);
        //清空一下购物车
    ...
    //返回给前端数据方法，包括订单信息和订单明细（里面包含收货地址相关的信息）的信息
    ...
    //减少产品库存
    private void reduceProductStork(List<OrderItem> orderItemList){
        for(OrderItem orderItem : orderItemList){
